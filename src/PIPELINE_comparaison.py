...
noStim_csv = "../data/analysis_results/#517/#517_CHR_Beta_RightHemi_CueL1_H001_LaserOff/metrics_per_clips.csv"
beta1_csv = "../data/analysis_results/#517/#517_CHR_Beta_RightHemi_CueL1_H001_LaserOn/metrics_per_clips.csv"
conti1_csv = "../data/analysis_results/#517/#517_CHR_Conti_RightHemi_CueL1_H001_LaserOn/metrics_per_clips.csv"

beta2_csv = "../data/analysis_results/#517/#517_CHR_Beta_RightHemi_CueL1_H001_LaserOn_2,5mW/metrics_per_clips.csv"
conti2_csv = "../data/analysis_results/#517/#517_CHR_Conti_RightHemi_CueL1_H001_LaserOn_0,75mW/metrics_per_clips.csv"

noStim_velo = pd.read_csv(noStim_csv)['velocity']
beta1_velo = pd.read_csv(beta1_csv)['velocity']
conti1_velo = pd.read_csv(conti1_csv)['velocity']

beta2_velo = pd.read_csv(beta2_csv)['velocity']
conti2_velo = pd.read_csv(conti2_csv)['velocity']
...
def build_long_df(noStim, conti1, beta1, conti2, beta2):
    ...
    df = pd.concat([
        ...
        _pack(noStim, "NoStim", "conti=0.75, beta=2.5"),  
        _pack(conti2, "Conti", "conti=0.75, beta=2.5"),
        _pack(beta2, "Beta", "conti=0.75, beta=2.5"),
    ], ignore_index=True)
...
beta1_csv = "../data/analysis_results/#517/#517_CTRL_Beta_LeftHemi_CueL1_H001_LaserOn/metrics_per_clips.csv"
conti1_csv = "../data/analysis_results/#517/#517_CTRL_Conti_LeftHemi_CueL1_H001_LaserOn/metrics_per_clips.csv"
