...
from rats_kinematics_utils.core.file_utils import dataframe_report, make_output_path, load_trial_data, check_analysis_choice
...
# for k,v in rat_proportion.items(): 
#     print(k, v)
...
if plot_choice["plot_metadata"] : 
    ...
    ir.inter_rat_metadata_report(cfg, cfg.rat_types, file_to_process_list)
...
if plot_choice["plot_lever_distance"] : 
    ...
    for error_function in [None, "pi","sem"] :
        ...
        g = pc.plot_tendency_per_rat(cfg, data, error_function)
